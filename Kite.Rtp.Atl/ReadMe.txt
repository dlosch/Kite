========================================================================
    ACTIVE TEMPLATE LIBRARY : Kite.Rtp.Atl Project Overview
========================================================================

AppWizard has created this Kite.Rtp.Atl project for you to use as the starting point for
...
_KiteRtpAtl.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Kite.Rtp.Atl.h)
        GUID definitions                                (_Kite.Rtp.Atl_i.c)
        A type library                                  (_KiteRtpAtl.tlb)
        Marshaling code                                 (_Kite.Rtp.Atl_p.c and dlldata.c)
Kite.Rtp.Atl.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Kite.Rtp.Atl.pch and a precompiled types file named StdAfx.obj.
...
Kite.Rtp.Atlps.vcproj
	...
	dlldata.c, Kite.Rtp.Atl_i.c and Kite.Rtp.Atl_p.c which are required
